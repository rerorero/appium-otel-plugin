...
class AppiumMeter {
  ...
  countCommandResponses(cmdName, stat, attributes) {
    ...
    console.log('natoring count');
    console.log(this.counterCommandResponses);
...
export class Collector {
  constructor(meter, attributesInCaps, observePeriodMillis, attributes = {}) {
    ...
    this.meter.observeOldestSessionAgeGauge(async () => this.oldestSessionAge());
  }
