 ...
 */
class SessionSemanticDelegater extends Delegator {
   ...
   */
  constructor(tracer, attributesInCaps) {
    super();
    this.tracer = tracer;
...
class SessionSemantic extends Semantic {
  newDelegater(conf, tracer) {
    return new SessionSemanticDelegater(tracer, conf.attributesInCaps);
  };

  registerOption(provider) {
    return { traceProvider: provider };
  };
}

export { SessionSemantic };
